...
public class DBCon11 {
	public static void main(String[] args) {
		try {
			...
			rs1.afterLast();
			while (rs1.previous()) {
				System.out.println(rs1.getString("code") + "\t" + rs1.getString("name") + "\t" + rs1.getFloat("price")
						+ "\t" + rs1.getInt("qty"));
			} // end of loop
			...
			rs2.absolute(3);
			System.out.println(rs2.getString("code") + "\t" + rs2.getString("name") + "\t" + rs2.getFloat("price")
					+ "\t" + rs2.getInt("qty"));
